...
$token = $user->createToken('deliveryboy-token')->plainTextToken;
    ...
    public function deleteLaborWork(Request $request)
    {
        try {
            $request->validate([
                'id' => 'required|string',
            ...
            if ($deleted) {
                return response()->json([
                    'status' => true,
                    'message' => 'Labour Work deleted successfully'
                ]);
            } else {
                return response()->json([
                    'status' => false,
   ...
   // Get Material Types and details by Material Name
    ...
    public function deleteMaterialInward(Request $request)
    {
        try {
            $request->validate([
                'id' => 'required|string',
            ...
            if ($deleted) {
                return response()->json([
                    'status' => true,
                    'message' => 'Material Inward deleted successfully'
                ]);
            } else {
                return response()->json([
                    'status' => false,
                    'message' => 'Material Inward not found'
                ], 404);
            }
