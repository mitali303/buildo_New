...
<main class="content">
    <div class="container-fluid p-0">
        ...
        <div class="mb-3">
            <h1 class="h3 d-inline align-middle">Create Call Outcome</h1>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <form action="@if(!empty($old)){{ route('CallOutcome.update') }}@else{{ route('CallOutcome.store') }}@endif" method="POST" enctype="multipart/form-data">
                            @csrf
                            @if(!empty($old))
                                @method('PUT')
                            ...
                            <a href="{{ route('CallOutcome') }}" class="btn btn-secondary">Cancel</a>
                        </form>
