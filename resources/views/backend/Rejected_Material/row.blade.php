...
<tr style="font-size:13px;">
    ...
    <td><input type="text" name="discount[]" class="form-control discount" oninput="calculateRow(this)"></td>
    <td><input type="text" name="taxable[]" class="form-control taxable" readonly></td>
    <td><input type="text" name="cgst[]" class="form-control cgst" onchange="calculateRow(this)"></td>
    <td><input type="text" name="sgst[]" class="form-control sgst" onchange="calculateRow(this)"></td>
    <td><input type="text" name="igst[]" class="form-control igst" onchange="calculateRow(this)"></td>
