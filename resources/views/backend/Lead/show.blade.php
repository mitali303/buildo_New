                                ...
                                @forelse($lead->calls->sortByDesc('call_date')->values() as $i => $call)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <button type="button" class="btn btn-sm toggle-complete-btn {{ $call->is_completed ? 'btn-success' : 'btn-outline-secondary' }}"
                                                data-id="{{ $call->id }}" style="font-size:.68rem; padding:.15rem .5rem;">
