            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="@if(!empty($old))
                                    {{ route('LateMarkCalculation.update') }}
                                  @else
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-3">
                                ...
                                <input type="number"
                                       ...
                                       class="form-control @error('late_mark_count') is-invalid @enderror"
                                       value="{{ old('late_mark_count',$old->late_mark_count ?? '') }}"
                                       placeholder="Enter Late Mark Count">
                            ...
                            <div class="mb-3 col-md-3">
                                ...
                                <input type="time"
                                       ...
                                       class="form-control @error('total_late_time') is-invalid @enderror"
                            ...
                            <div class="mb-3 col-md-3">
                                ...
                                <input type="number"
                                       ...
                                       min="0"
                                       name="amount_reduce"
                                       class="form-control @error('amount_reduce') is-invalid @enderror"
                                       value="{{ old('amount_reduce',$old->amount_reduce ?? '') }}"
                                       placeholder="Enter Amount Reduce">
                        ...
                        <a href="{{ route('LateMarkCalculation') }}"
