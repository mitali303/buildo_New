...
<main class="content">
    <div class="container-fluid p-0">
        <div class="row mb-2 mb-xl-3">
            <div class="col-auto">
                <h3><strong></strong>Land Expenses</h3>
            </div>
            <div class="col-auto ms-auto text-end mt-n1">
                
                @if (hasPermission('create_land_expenses') == true)
                    <a href="{{route('land_expenses.create')}}" class="btn btn-sm btn-primary"><i class="fas fa-plus"></i>Add New Record</a>
                @endif
            </div>
        </div>
        <div class="row mb-3">
