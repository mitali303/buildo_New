...
<input type="hidden" name="Pid" value="{{ $invoice->ID ?? '' }}">
                    ...
                    <tbody>
                        ...
                        @endphp
                            ...
                            {{-- GST Amount --}}
                            <td>
                                <input type="text" class="form-control" name="tax" id="tax" value="{{ old('tax', $invoice->TaxAmt ?? '') }}" oninput="calculatePayable()">
                            ...
                            {{-- TDS Amount --}}
                            <td>
                                <input type="text" class="form-control" name="tds" id="tds" value="{{ old('tds', $invoice->TDSAmt ?? '') }}" oninput="calculatePayable()">
                            ...
                            <td id="bankvalue" style="display:none;">
                                <input type="text" class="form-control" name="bnk_charge" id="bnk_charge">
                                @error('bnk_charge')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </td>
