...
<main class="content">
    <div class="container-fluid p-0">
        ...
        <div class="mb-3">
            <h1 class="h3 d-inline align-middle">Create Call Purpose</h1>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <form action="@if(!empty($old)){{ route('CallPurpose.update') }}@else{{ route('CallPurpose.store') }}@endif" method="POST" enctype="multipart/form-data">
                            @csrf
                            @if(!empty($old))
                            @method('PUT')
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-4">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                                        ...
                                        placeholder="Enter Call Purpose Name">
                                    @error('name')
                            ...
                            <a href="{{ route('CallPurpose') }}" class="btn btn-secondary">Cancel</a>
                        </form>
