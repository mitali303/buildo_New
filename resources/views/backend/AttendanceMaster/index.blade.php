        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <div class="d-flex gap-2 flex-wrap">
                @if (hasPermission('create_AttendanceMaster') == true)
                    <a href="{{ route('AttendanceMaster.create') }}" class="btn btn-primary px-2 px-md-3 py-1 py-md-2">
                        <i class="fas fa-plus"></i> Attendance Master
                    </a>
                @endif

                <!-- IMPORT BUTTON -->
                <button class="btn btn-success px-2 px-md-3 py-1 py-md-2" data-bs-toggle="modal" data-bs-target="#importModal">
        ...
        <div class="modal-content">
            <form action="{{ route('attendance.import') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-header">
                    <h5 class="modal-title"> Import Attendance Excel </h5>
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    var datatablesButtons = $("#datatables-buttons").DataTable({
        ...
        columns: [
                    ...
                    {   data: 'late_mins',  name: 'late_mins' },
                    {   data: 'early_dep',  name: 'early_dep'  },
                    {   data: 'work_hr',    name: 'work_hr'  },
                    {   data: 'ot_hr',    name: 'ot_hr'  },
