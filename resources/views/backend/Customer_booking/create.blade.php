        ...
        <div class="card">
          ...
          <div class="card-body">
            <form action="@if(!empty($postdated)){{ route('customer_booking.update') }}@else{{ route('customer_booking.store') }}@endif"
                ...
                <div class="table-responsive">
                  <table class="table table-striped table-bordered" style="height: 100px;width:90%">
                    ...
                    <tbody>
                      <tr style="height: 50px">
                        <td>
                          <div class="col-md-4" id="wing"> @if(!empty($postdated)) {{ $flat_detail->first()->Wing ?? '' }} @endif</div>
                        </td>
                        <td>
                          <div class="col-md-4" id="floor">@if(!empty($postdated)) {{ $flat_detail->first()->Floor ?? '' }} @endif</div>
                        </td>
                        <td>
                          <div class="col-md-4" id="area"> @if(!empty($postdated)) {{ $flat_detail->first()->Area ?? '' }} @endif</div>
                        </td>

                        <td>
                          <div class="col-md-4" id="Other1">@if(!empty($postdated)) {{ $flat_detail->first()->Other1 ?? '' }} @endif</div>
                        </td>
                        <td>
                          <div class="col-md-4" id="Other2">@if(!empty($postdated)) {{ $flat_detail->first()->Other2 ?? '' }} @endif</div>
                        </td>
                        <td>
                          <div class="col-md-4" id="TerraceArea">@if(!empty($postdated)) {{ $flat_detail->first()->Terrace ?? '' }} @endif</div>
                        </td>
                        <td>
                          <div class="col-md-4" id="Attribute"> @if(!empty($postdated)) {{ $flat_detail->first()->FlatAttribute ?? '' }} @endif</div>
                        <td>
                          <div class="col-md-4" id="totalSqFt">@if(!empty($postdated)) {{ $flat_detail->first()->TotalSqFt ?? '' }} @endif</div>
                        </td>

                        <input name="farea" id="farea" type="hidden" value=" <?php //echo $Flatdetails_rec['TotalSqFt']; 
                                                                              ?>" onkeyup="calccost();" onblur="calccost();" /></td>
                      </tr>
                    </tbody>
                  </table>
                </div>
              ...
              <?php
              if (!empty($postdated)) {
                if ($postdated->Ptype == '1' || $postdated->Ptype == '2') {
                  $disp_box = "";
                } else {
                  $disp_box = "none";
                }
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          ...
                          <input type="hidden" style="" name="amount_pay_old" id="amount_pay_old" value="<?php //echo $pendingAmt;
