                    ...
                    <div class="row mt-3 mb-3">
                        <div class="col-md-12">
                            <div class="table-responsive">
                                ...
                                <h4 class="text-end"> Grand Total : ₹ <span id="gtotal">0</span></h4>
                            </div>
                        </div>
                    </div>
                    {{-- Submit --}}
                    ...
                    <input type="hidden" name="from_labour_work" value="1">
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" name="ContactNo" value="{{ old('ContactNo') }}" class="form-control @error('ContactNo') is-invalid @enderror">
                                @error('ContactNo')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>Mistri</td>
                                    <td>
                                        <input name="MistriMaleRate" value="{{ old('MistriMaleRate') }}"
                                    ...
                                    <td>
                                        <input name="MistriFemaleRate" value="{{ old('MistriFemaleRate') }}"
                                ...
                                <tr>
                                    <td>Labour</td>
                                    <td>
                                        <input name="LabourMaleRate" value="{{ old('LabourMaleRate') }}"
                                    ...
                                    <td>
                                        <input name="LabourFemaleRate" value="{{ old('LabourFemaleRate') }}"
                                ...
                                <tr>
                                    <td>Thekedar</td>
                                    <td>
                                        <input name="ThekedarMaleRate" value="{{ old('ThekedarMaleRate') }}"
                                    ...
                                    <td>
                                        <input name="ThekedarFemaleRate" value="{{ old('ThekedarFemaleRate') }}"
